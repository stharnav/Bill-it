      ...
      <div class="container-fluid">
        @if (session('success'))
              <div class="alert alert-success">
                  ...
                  <br>
                    <div class="row">
                      <a href="{{ route('products.product') }}" class="btn btn-info">View Products</a>
                    </div>
              </div>
          ...
          @if($errors->any())
              <div class="alert alert-danger">
                  ...
                  <div class="row">
                    <a href="{{ route('categories.add-category') }}" class="btn btn-info">Create Category</a>
                  </div>
              </div>
          @endif
              ...
              <form method="POST" action="{{ route('product.store') }}">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col form-group">
                      <select>
                        <option class="form-control">Sub Category</option>
